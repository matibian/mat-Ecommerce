const itemsData = [{
    ...
    description :"Tipo aplicable: monitoreo de disco duro/disco duro móvil/monitoreo de seguridad DVR Disco Duro Dedicado/disco duro NVR HD/disco duro grabador de vídeo. Tamaño del disco duro: 3,5.",
    stock: 8, 
    inicial: 1, 
    ...
    category: "Perifericos",
    description :'Disfrutá de tus partidas en otro nivel con Redragon, marca reconocida que se especializa en brindar la mejor experiencia de juego al público gamer desde hace más de 20 años', 
    stock: 4, 
    inicial: 1, 
