...
export default function ItemListContainer() {
    ...
    const items = [{
        id:1, 
        name: "Msi Nvidia Geforce Rtx 3090 Gaming Trio 24gb Gddr6", 
        ...
        id:2, 
        name: "Disco duro interno hdd de 3,5 pulgadas, 4TB SATA III", 
        ...
        id:4, 
        name: 'Placa de video Nvidia Zotac Gaming GeForce RTX 20', 
        ...
        id:5, 
        name: 'Mouse Logitech G Series Lightspeed G502 negro', 
        ...
        id:6, 
        name: 'Teclado Dragonborn K630 QWERTY Redragon Brown', 
